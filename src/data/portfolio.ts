export const portfolioData = {
    ...
    featuredProjects: [
        {
            title: "ATLAS",
            subtitle: "Advanced Trading Lifecycle & Audit System",
            tagline: "Event-driven infrastructure for high-throughput trading execution and regulatory-grade auditability.",
            description: "A production-inspired prototype modeling modern trading and exchange infrastructure. ATLAS cleanly decouples the low-latency execution path from downstream analytics using Kafka-compatible event streaming via Redpanda. Features a custom Order Management System, venue simulation, and immutable event capture for strict regulatory-style audit trails—bridging real-time market infrastructure with robust data telemetry.",
            highlights: [
                "Decoupled hot execution paths from analytics workloads using Redpanda event streaming",
                "Immutable order lifecycle capture for regulatory-grade transaction auditability",
                "Integrated Prometheus & Grafana telemetry pipeline for system health monitoring",
                "End-to-end trading console for real-time order management and venue simulation"
            ],
            techIds: ["Redpanda (Kafka)", "AWS S3", "Athena/Redshift", "Prometheus", "Grafana", "Event-Driven Architecture"],
            ...
            details: {
                ...
                impact: "Production-grade trading lifecycle modeling with full auditability and scalable streaming infrastructure.",
            }
        },
        {
            title: "Acquisition Intelligence",
            subtitle: "AI-Powered Underwriting Advisory Platform",
            tagline: "Executive-grade AI underwriting for institutional real estate evaluation.",
            description: "An institutional-grade underwriting platform bridging deterministic financial modeling with advanced AI advisory layers to accelerate capital investment decisions. Dynamically calculates critical commercial metrics—NOI, Cap Rates, DSCR, and Leveraged Cash Flow—while generating contextual AI investment memos with dynamic target entry basis negotiation and downside sensitivity testing.",
            highlights: [
                "Hybrid deterministic + LLM-generated institutional investment memo system",
                "Dynamic sensitivity analysis for downside scenarios and LTV thresholds",
                "Interactive 'Explain Recommendation' and 'What Changes Verdict' decision flows",
                "Boardroom-ready UI for deal screening and multi-portfolio comparison"
            ],
            techIds: ["React", "Vite", "Tailwind CSS", "shadcn/ui", "Recharts", "AI Advisory API"],
            ...
            details: {
                ...
                solution: "Deterministic financial modeling fused with LLM advisory, interactive stress-testing, and institutional-style decision support.",
                impact: "Executive-grade deal evaluation with AI-generated investment memos and dynamic negotiation intelligence.",
            }
        }
    ],
    projects: [
